                    ...
                    >
                      <Paper elevation={4} style={{ padding: "10px" }}>
                        ...
                        <Stack spacing={2} direction="row">
                          <Button variant="outlined" style={{borderColor:"grey" ,width:"25%"}}>Bug</Button>
                          <Button variant="outlined" style={{borderColor:"grey" ,width:"25%"}}>Content</Button>
                          <Button variant="outlined" style={{borderColor:"grey" ,width:"25%"}}>Other</Button>
                        </Stack>
